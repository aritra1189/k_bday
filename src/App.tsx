...
function FloatingIcon({ Icon, delay }: { Icon: LucideIcon, delay: number }) {
  return (
    <motion.div
...
function App() {
  ...
  const handleCakeCeremonyComplete = () => {
    setTimeout(() => {
      setStage(4);
    }, 3000);
  };
  ...
  const handleButtonClick = (choice: string) => {
    if (choice === 'Yes, please!') {
      ...
      setStage(1); // Transition to PhotoGallery
    }
  };
  ...
  const messages = [
    "Hey Krixxx✨, today is all about you! 💖",
    "I've created something truly magical, just for you... ✨",
    "But before you begin, I need you to know you are the most incredible, beautiful soul I've ever met, and I cherish you more than words can ever express. ❤️"
  ];
  ...
  const renderStage = () => {
    switch (stage) {
      ...
      case 1:
        return <PhotoGallery onComplete={() => setStage(2)} />;
      case 2:
        return (
          <Room
            isLightOn={isLightOn}
      ...
      case 3:
        return <CakeCeremony onComplete={handleCakeCeremonyComplete} />;
      case 4:
        return <FinalMessage />;
      default:
        return null;
